"""One-off: add the dominant_colour/named_idiom columns to an existing
...
against any DB, any number of times - a no-op if the columns are already
present. Same pattern as migrate_candidates_art_brief.py.
"""
import sqlite3
import sys
