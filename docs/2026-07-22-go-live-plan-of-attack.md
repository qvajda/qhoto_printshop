...
**E1. GL-45 — the Telegram drops.** First of the four, because it is the only
one that corrupts decisions and because its cheapest hypothesis costs ten
seconds. Brief: `docs/2026-08-09-gl45-telegram-drops-brief.md`.

**E2. GL-47 then GL-46, in that order or the same session.** GL-47 stops the
...
**E3. GL-48 — the crop.** One read-only `GET` decides whether this is a
...
**E4. GL-49 — repair candidates 44, 47, 48**, after E0's DB reconciliation,
never before.

**E5. Re-soak — short, live, targeted.** Not another open-ended two-nighter:
